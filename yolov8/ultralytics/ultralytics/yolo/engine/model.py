...
class YOLO:
    ...
    def __init__(self, model='yolov8n.yaml', type="v8", cmd_args = {}) -> None:
        """
    ...
    @smart_inference_mode()
    def val(self, data=None, task=None, **kwargs):
        """
        ...
        validator = self.ValidatorClass(args=args,task=task)
    ...
    def train(self, **kwargs):
        ...
        self.trainer.wandb = wandb.init( entity = self.cmd_args.entity , project = self.cmd_args.project, name = self.cmd_args.name, config = self.cmd_args )
